...
md"🦆 devise an order-of-magnitude guess for $p$ [g/day], based on the measurement of the concentration of pollutant in the pond after one day.
...
🦆 suppose you are hired as a consultant in court for this case. it is illegal to dump more than 20 g/day into the lake. the company denies it was polluting the pond above this rate. would you testify that the company exceeded this limit or not? how would you explain to the court what _you_ think the verdict should be?
"
