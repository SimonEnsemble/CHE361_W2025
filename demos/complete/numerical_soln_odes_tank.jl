...
Δts = [9.1, 8.45, 9.45, 9.4, 9.81, 9.01, 9.35, 10.51, 10.2, 11.03, 11.58, 11.51, 11.0, 12.06, 11.46, 12.5, 14.62, 14.0, 16.58, 18.63, 17.51, 22.65, 29.82]
...
exp_data = DataFrame(
	"h [cm]" => [25 - i for i = 0:22],
	"t [s]" => [sum(Δts[1:i]) for i = 0:22]
)
